...
from motion_planning_scene_helpers.reference_trajectory import ReferenceTrajectory
...
class SplineTrajectory(ReferenceTrajectory):
    def __init__(self, n: int, **kwargs):
        ...
        if "duration" not in self._trajDict.keys():
            raise TrajectoryComponentMissingError(
                "Spline definition not complete."\
                "Missing component in trajectory: duration"
            )
