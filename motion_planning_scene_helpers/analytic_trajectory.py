...
from motion_planning_scene_helpers.reference_trajectory import ReferenceTrajectory, t
...
class AnalyticTrajectory(ReferenceTrajectory):
    def __init__(self, n: int, **kwargs):
        ...
        if "traj" not in kwargs:
            ...
            "Trajectory definition not complete. Missing component: traj")
        self._t = t
    ...
    def concretize(self):
        ...
        self._funs = ca.Function(
                "traj", [self._t], [self._traj, self._v, self._a])
